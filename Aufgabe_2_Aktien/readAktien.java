    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            ...
            for( int firma=0; firma<c.dataCompanies.length; firma++) {
                ...
                String URL = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=" + Stock + "&outputsize=full&apikey=A4RM4YPCEWJ1VANI3";
                ...
                for (int i = 0; i < closeWerteDB.size() - 1; i++) {
                    CloseWerte.getData().add(new XYChart.Data(DatumDB.get(i), adjustedcloseWerteDB.get(i)));
                }
                ...
                closeWerteDB.clear();
                durchschnitt.clear();
                adjustedCloseWerte.clear();
                adjustedcloseWerteDB.clear();
